...
\begin{figure}[H]
    \includegraphics[width=\linewidth]{impl_dsgn_Fault Identification Verification}
...
\subsubsection{Fault injection and filtering sub modules}
...
\begin{figure}[H]
    ...
    \hfill
     \subfloat[Fault Correction Frame 40\label{fig:postNR40a}]{%
...
\begin{figure}[H]
    ...
    \hfill
     \subfloat[Permanent Fault Identified Image Frame 65\label{fig:faultID65}]{%
        \includegraphics[width=0.45\linewidth]{noiseIdentification-0065}}
    \\
     \subfloat[Permanent Fault Identified Image Frame 75\label{fig:faultID75}]{%
        \includegraphics[width=0.45\linewidth]{noiseIdentification-0075}}
    \hfill
     \subfloat[Permanent Fault Identified Image Frame 100\label{fig:faultID100}]{%
